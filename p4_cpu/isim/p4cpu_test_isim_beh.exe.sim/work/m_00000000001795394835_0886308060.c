...
#endif
static const char *ng0 = "D:/ise/p4_cpu/ALU.v";
...
LAB79:    if (*((unsigned int *)t175) < *((unsigned int *)t176))
        goto LAB77;
...
LAB93:    if (*((unsigned int *)t185) > 0)
        goto LAB94;

LAB95:    memcpy(t184, t222, 8);

LAB96:    goto LAB69;

LAB70:    xsi_vlog_unsigned_bit_combine(t143, 32, t177, 32, t184, 32);
    goto LAB74;
...
LAB88:    t215 = (t0 + 1208U);
    ...
    t215 = ((char*)((ng6)));
    memset(t217, 0, 8);
    xsi_vlog_unsigned_lshift(t217, 32, t216, 32, t215, 32);
    goto LAB89;

LAB90:    t222 = ((char*)((ng1)));
    goto LAB91;

LAB92:    xsi_vlog_unsigned_bit_combine(t184, 32, t217, 32, t222, 32);
    goto LAB96;

LAB94:    memcpy(t184, t217, 8);
    goto LAB96;
...
extern void work_m_00000000001795394835_0886308060_init()
{
	static char *pe[] = {(void *)Cont_30_0,(void *)Cont_37_1};
	xsi_register_didat("work_m_00000000001795394835_0886308060", "isim/p4cpu_test_isim_beh.exe.sim/work/m_00000000001795394835_0886308060.didat");
