...
#endif
static const char *ng0 = "D:/ise/p7/SU.v";
static int ng1[] = {0, 0};
static int ng2[] = {1, 0};
static int ng3[] = {3, 0};
static int ng4[] = {2, 0};
...
LAB30:    t402 = (t0 + 12656);
    ...
    *((unsigned int *)t412) = (t414 | t408);
    xsi_driver_vfirst_trans(t402, 0, 2);
    t415 = (t0 + 12384);
    *((int *)t415) = 1;
...
LAB36:    memcpy(t103, t75, 8);

LAB37:    memset(t135, 0, 8);
    t136 = (t103 + 4);
...
LAB54:    memcpy(t157, t135, 8);

LAB55:    memset(t185, 0, 8);
    t186 = (t157 + 4);
...
LAB68:    memcpy(t207, t185, 8);

LAB69:    memset(t235, 0, 8);
    t236 = (t207 + 4);
...
LAB82:    memcpy(t257, t235, 8);

LAB83:    memset(t285, 0, 8);
    t286 = (t257 + 4);
...
LAB96:    memcpy(t307, t285, 8);

LAB97:    memset(t335, 0, 8);
    t336 = (t307 + 4);
...
LAB110:    memcpy(t357, t335, 8);

LAB111:    memset(t72, 0, 8);
    t385 = (t357 + 4);
...
LAB122:    t392 = (t72 + 4);
    t393 = *((unsigned int *)t72);
    t394 = *((unsigned int *)t392);
    t395 = (t393 || t394);
    if (t395 > 0)
        goto LAB123;

LAB124:    t397 = *((unsigned int *)t72);
    t398 = (~(t397));
...
LAB126:    if (*((unsigned int *)t392) > 0)
        goto LAB127;

LAB128:    if (*((unsigned int *)t72) > 0)
        goto LAB129;

LAB130:    memcpy(t71, t401, 8);
...
LAB99:    if (*((unsigned int *)t298) != 0)
        goto LAB100;

LAB101:    t308 = *((unsigned int *)t285);
...
LAB123:    t396 = ((char*)((ng2)));
    goto LAB124;

LAB125:    t401 = ((char*)((ng3)));
    goto LAB126;

LAB127:    xsi_vlog_unsigned_bit_combine(t71, 32, t396, 32, t401, 32);
    goto LAB131;

LAB129:    memcpy(t71, t396, 8);
    goto LAB131;
...
LAB66:    xsi_vlog_unsigned_bit_combine(t90, 32, t154, 32, t159, 32);
    goto LAB70;
...
LAB44:    t191 = (t0 + 12784);
    ...
    *((unsigned int *)t201) = (t203 | t197);
    xsi_driver_vfirst_trans(t191, 0, 2);
    t204 = (t0 + 12416);
    *((int *)t204) = 1;
...
LAB67:    xsi_vlog_unsigned_bit_combine(t121, 32, t185, 32, t190, 32);
    goto LAB71;
...
extern void work_m_00000000002594993450_3097610606_init()
{
	static char *pe[] = {(void *)Cont_51_0,(void *)Cont_54_1,(void *)Cont_76_2,(void *)Cont_94_3,(void *)Cont_100_4,(void *)Cont_101_5,(void *)Cont_102_6,(void *)Cont_106_7,(void *)Cont_107_8,(void *)Cont_108_9,(void *)Cont_112_10,(void *)Cont_116_11,(void *)Cont_118_12};
	xsi_register_didat("work_m_00000000002594993450_3097610606", "isim/mips_txt_2_isim_beh.exe.sim/work/m_00000000002594993450_3097610606.didat");
