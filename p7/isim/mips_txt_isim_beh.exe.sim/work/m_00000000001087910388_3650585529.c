...
#endif
static const char *ng0 = "D:/ise/p7/D_NPC.v";
...
LAB55:    t112 = ((char*)((ng3)));
    ...
    *((unsigned int *)t115) = t119;
    ...
    t121 = (t120 >> 28);
    *((unsigned int *)t113) = t121;
    t122 = *((unsigned int *)t115);
    *((unsigned int *)t115) = (t122 & 15U);
    t123 = *((unsigned int *)t113);
    *((unsigned int *)t113) = (t123 & 15U);
    xsi_vlogtype_concat(t111, 32, 32, 3U, t115, 4, t114, 26, t112, 2);
    goto LAB56;
...
LAB65:    *((unsigned int *)t132) = 1;

LAB67:    memset(t129, 0, 8);
    t148 = (t132 + 4);
...
LAB77:    if (*((unsigned int *)t129) > 0)
        goto LAB78;

LAB79:    memcpy(t128, t165, 8);

LAB80:    goto LAB58;

LAB59:    xsi_vlog_unsigned_bit_combine(t80, 32, t111, 32, t128, 32);
    goto LAB63;

LAB61:    memcpy(t80, t111, 8);
    goto LAB63;
...
LAB82:    *((unsigned int *)t168) = 1;

LAB84:    memset(t184, 0, 8);
    t185 = (t168 + 4);
...
LAB90:    memcpy(t205, t184, 8);

LAB91:    memset(t166, 0, 8);
    t237 = (t205 + 4);
...
LAB102:    t244 = (t166 + 4);
    t245 = *((unsigned int *)t166);
    t246 = *((unsigned int *)t244);
    t247 = (t245 || t246);
    if (t247 > 0)
        goto LAB103;

LAB104:    t267 = *((unsigned int *)t166);
    t268 = (~(t267));
...
LAB108:    if (*((unsigned int *)t166) > 0)
        goto LAB109;

LAB110:    memcpy(t165, t273, 8);

LAB111:    goto LAB75;

LAB76:    xsi_vlog_unsigned_bit_combine(t128, 32, t160, 32, t165, 32);
    goto LAB80;

LAB78:    memcpy(t128, t160, 8);
    goto LAB80;
...
LAB103:    t248 = (t0 + 1208U);
    t249 = *((char **)t248);
    t248 = ((char*)((ng2)));
    memset(t250, 0, 8);
    xsi_vlog_unsigned_add(t250, 32, t249, 32, t248, 32);
    t252 = ((char*)((ng3)));
    t253 = (t0 + 1688U);
    t254 = *((char **)t253);
    t253 = ((char*)((ng7)));
    ...
    *((unsigned int *)t256) = t265;
    xsi_vlog_mul_concat(t255, 14, 1, t253, 1U, t258, 1);
    xsi_vlogtype_concat(t251, 32, 32, 3U, t255, 14, t254, 16, t252, 2);
    memset(t266, 0, 8);
    xsi_vlog_unsigned_add(t266, 32, t250, 32, t251, 32);
    goto LAB104;
...
LAB107:    xsi_vlog_unsigned_bit_combine(t165, 32, t266, 32, t273, 32);
    goto LAB111;

LAB109:    memcpy(t165, t266, 8);
    goto LAB111;

}


extern void work_m_00000000001087910388_3650585529_init()
{
	static char *pe[] = {(void *)Cont_38_0};
	xsi_register_didat("work_m_00000000001087910388_3650585529", "isim/mips_txt_isim_beh.exe.sim/work/m_00000000001087910388_3650585529.didat");
