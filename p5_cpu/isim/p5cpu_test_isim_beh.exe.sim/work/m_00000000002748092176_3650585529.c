...
#endif
static const char *ng0 = "D:/ise/p5_cpu/D_NPC.v";
...
LAB29:    t72 = ((char*)((ng1)));
    ...
    *((unsigned int *)t73) = (t83 & 15U);
    xsi_vlogtype_concat(t71, 32, 32, 3U, t75, 4, t74, 26, t72, 2);
    goto LAB30;
...
LAB53:    memcpy(t88, t125, 8);

LAB54:    goto LAB32;

LAB33:    xsi_vlog_unsigned_bit_combine(t40, 32, t71, 32, t88, 32);
    goto LAB37;
...
LAB64:    memcpy(t165, t144, 8);

LAB65:    memset(t126, 0, 8);
    t197 = (t165 + 4);
...
LAB74:    if (*((unsigned int *)t197) != 0)
        goto LAB75;

LAB76:    t204 = (t126 + 4);
    t205 = *((unsigned int *)t126);
    t206 = *((unsigned int *)t204);
    t207 = (t205 || t206);
    if (t207 > 0)
        goto LAB77;

LAB78:    t227 = *((unsigned int *)t126);
    t228 = (~(t227));
...
LAB80:    if (*((unsigned int *)t204) > 0)
        goto LAB81;

LAB82:    if (*((unsigned int *)t126) > 0)
        goto LAB83;

LAB84:    memcpy(t125, t233, 8);

LAB85:    goto LAB49;

LAB50:    xsi_vlog_unsigned_bit_combine(t88, 32, t120, 32, t125, 32);
    goto LAB54;

LAB52:    memcpy(t88, t120, 8);
    goto LAB54;
...
LAB67:    if (*((unsigned int *)t156) != 0)
        goto LAB68;

LAB69:    t166 = *((unsigned int *)t144);
...
LAB77:    t208 = (t0 + 1208U);
    ...
    *((unsigned int *)t216) = t225;
    xsi_vlog_mul_concat(t215, 14, 1, t213, 1U, t218, 1);
    xsi_vlogtype_concat(t211, 32, 32, 3U, t215, 14, t214, 16, t212, 2);
    memset(t226, 0, 8);
    xsi_vlog_unsigned_add(t226, 32, t210, 32, t211, 32);
    goto LAB78;
...
LAB79:    t231 = (t0 + 1048U);
    ...
    t231 = ((char*)((ng2)));
    memset(t233, 0, 8);
    xsi_vlog_unsigned_add(t233, 32, t232, 32, t231, 32);
    goto LAB80;

LAB81:    xsi_vlog_unsigned_bit_combine(t125, 32, t226, 32, t233, 32);
    goto LAB85;

LAB83:    memcpy(t125, t226, 8);
    goto LAB85;

}


extern void work_m_00000000002748092176_3650585529_init()
{
	static char *pe[] = {(void *)Cont_34_0};
	xsi_register_didat("work_m_00000000002748092176_3650585529", "isim/p5cpu_test_isim_beh.exe.sim/work/m_00000000002748092176_3650585529.didat");
